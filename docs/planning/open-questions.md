...
| OQ-23 | `require-review` forge mechanics: how does the GitLab adapter *prove* eligible approval (approval rules API? CODEOWNERS evidence?) per tier; GitHub equivalent | ADR-0017 accept / contract fixture | free-tier GitLab may lack approval-rule APIs — capability gap → no auto-merge |
