...
| P2-E5 | ADR acceptance round (0002–0017 → Accepted/Superseded) | [spec](p2-e5-adr-acceptance/spec.md) | Blocked on all P2 spikes + P1-E3/E4 | yes (operator review) | **the Phase-2 gate** |
...
| Phase | Epics | Gate |
| --- | --- | --- |
| 3 — Contracts first | P3-E1 schemas + contract fixture · P3-E2 versioning/compat spec · P3-E3 example migration | strict end-to-end contract fixture validates (ADR-0017 §8, D-016) |
| 4 — Walking skeleton | P4-E1 | L3 skeleton green + **one real repo on live MRs** (D-012) |
| 5 — Implementation | E1–E9 active; E10–E13 **locked** (D-012) | per-epic; E7 starts alongside E1 |
